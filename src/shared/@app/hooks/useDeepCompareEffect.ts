...
export function useDeepCompareMemoize<T>(value: T) {
  ...
  // biome-ignore lint/correctness/useExhaustiveDependencies: signalRef triggers re-memoization
...
function useDeepCompareEffect(
  ...
  // eslint-disable-next-line react-hooks/exhaustive-deps
  // biome-ignore lint/correctness/useExhaustiveDependencies: custom deep compare hook
